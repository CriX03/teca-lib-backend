...
def _ensure_book_available(libro: dict[str, Any]) -> None:
    ...
    if not disponible:
        raise ApiError("BOOK_NOT_AVAILABLE", "El libro no esta disponible para prestamo.", 409)
...
def create_prestamo(
    ...
    *,
    ...
    active_loan = Prestamo.query.filter_by(libro_id=libro_id, estado=ESTADO_ACTIVO).first()
